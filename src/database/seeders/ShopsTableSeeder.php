...
class ShopsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $param = [
            ...
            'image' => '2SuXY822PP5cVmr9Fep3CRM9zdWWuDiUzkkJJwG9.jpg'
        ];
        ...
        $param = [
            ...
            'image' => '4KfDGaLT3WGQaSvQO2IIxpKlG7sU5RR2Ogh9K4Ok.jpg'
        ];
        DB::table('shops')->insert($param);
        ...
        $param = [
            ...
            'image' => '7sCj3sHGF324a3ApMUviehlw1tj2Iwgnql1K9Ql1.jpg'
        ];
        DB::table('shops')->insert($param);
        ...
        $param = [
            ...
            'image' => '1iKCJSOK48BCOjDPHPYNaAruLIkpjROIEKBVwvcV.jpg'
        ];
        DB::table('shops')->insert($param);
        ...
        $param = [
            ...
            'image' => '2eFoeQY5WYeRTvIXTnMrznEzaCgBU6RG3X9A45SK.jpg'
        ];
        DB::table('shops')->insert($param);
